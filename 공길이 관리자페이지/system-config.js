...
SYSTEM_CONFIG.SSL_KEYSTORE_PUB = {
      ca:   path.join('d:/Apache24/keystore/wildcard-orcasoft.co.kr', 'orcasoft.co.kr-chain.pem')
    , cert: path.join('d:/Apache24/keystore/wildcard-orcasoft.co.kr', 'orcasoft.co.kr-crt.pem'  )
    , key:  path.join('d:/Apache24/keystore/wildcard-orcasoft.co.kr', 'orcasoft.co.kr-key.pem'  )
};
